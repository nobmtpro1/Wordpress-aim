<div class="wrap">
    ...
    <h2>
        <?php _e('Newsletters', 'wpbc') ?> <a class="add-new-h2" href="<?php echo get_admin_url(get_current_blog_id(), 'admin.php?page=aim_newsletter&my_action=add_or_edit'); ?>"><?php _e('Add new', 'wpbc') ?></a>
    </h2>
    <?php echo $message; ?>
